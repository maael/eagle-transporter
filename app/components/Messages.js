    ...
    return this.props.messages && this.props.messages.success ? (
      <div className='ui success message'>
        <div className='header'>
          {this.props.messages.success.map((message, index) => <div key={index}><i className='icon check' /> {message.msg}</div>)}
        </div>
      </div>
    ) : this.props.messages && this.props.messages.error ? (
      <div className='ui error message'>
        <div className='header'>
          {this.props.messages.error.map((message, index) => <div key={index}><i className='icon warning' /> {message.msg}</div>)}
        </div>
      </div>
